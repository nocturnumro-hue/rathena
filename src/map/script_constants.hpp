...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(SC_REBIRTH_REGEN); // VIP Rebirth Regen Icon
	export_constant(SC_VIPSTATE); // VIP Status Icon
	export_constant(SC_AUTOTIME); // AUTO OFF Icon
	export_constant(SC_AUTOTIMEON); // AUTO ON Icon
...
=======
	export_constant(EFST_REBIRTH_REGEN); // VIP Rebirth Regen Icon
	export_constant(EFST_VIPSTATE); // VIP Status Icon
	export_constant(EFST_AUTOTIME); // AUTO OFF Icon
	export_constant(EFST_AUTOTIMEON); // AUTO ON Icon
